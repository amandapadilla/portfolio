    ...
    <div className="about">
      ...
      <section className="about__text">
        <p className="about__paragraph">
          ...
          to research and adopt new forms of communication.
        </p>
        <p className="about__paragraph">
          ...
          interactive experiences UX analytics. I love to explore my attention
          to details in User Experience and Interfaces and always trying to make
          it better.
        </p>
        <p className="about__paragraph">
          ...
          learning and incorporating new skills in community as my passion.
        </p>
        <p className="about__paragraph">
